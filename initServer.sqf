 ...
 */
[] spawn {
	waitUntil { !isNil "tSF_fnc_ERS_assignRadioByConfig" };
	private _tankClass = [
		"rhs_t90_tv"
		,"CUP_O_T90_RU"
		,"CUP_O_T72_TKA"
		,"CUP_O_T55_TK"
	] select ("par_tankVehicle" call BIS_fnc_getParamValue);

	{
		private _tank = [_x, _tankClass, "kit_cargo_tank"] call dzn_fnc_createVehicle;
		[_tank , "BLUFOR"] call tSF_fnc_ERS_assignRadioByConfig
	} forEach [tankPos1, tankPos2];
};